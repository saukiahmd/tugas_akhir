            ...
            <table class="table table-bordered">
                ...
                <?php while($pecah=$ambil->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <a href="ubahkategori.php?id=<?php echo $pecah['id_kategori']; ?>" class="btn btn-warning" >Ubah</a>
                        <a href="hapuskategori.php?id=<?php echo $pecah['id_kategori']; ?>" class="btn-danger btn"  >Hapus</a>
