    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <table class="table table-bordered">
                ...
                <?php
                $nomor=1;
                $ambil=$koneksi->query("SELECT * FROM checkout");
                $ambil1=$koneksi->query("SELECT * FROM pembelian");
                ?>
                <?php while($pecah=$ambil->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <a href="ubahpembelian.php?id=<?php echo $pecah['id_checkout']; ?>" class="btn btn-warning mr-2" >Ubah</a>
                        <a href="hapuspembelian.php?id=<?php echo $pecah['id_checkout']; ?>" class="btn-danger btn"  >Hapus</a>
