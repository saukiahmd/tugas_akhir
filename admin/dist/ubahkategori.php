            ...
            <div id="layoutSidenav_content">
                ...
                <form method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" value="<?php echo $pecah['nama_kategori']; ?>" id="inputNamaProduk" type="text" name="namakategori" placeholder="Masukan Nama Produk" />
                                            </div>
                <div class="modal-footer">
                    <a href="kategori.php" class="btn btn-secondary">Keluar</a>
...
<?php
	if(isset($_POST['ubah']))
	{
                ...
                $koneksi->query("UPDATE kategori SET nama_kategori='$_POST[namakategori]' WHERE id_kategori='$_GET[id]'");
