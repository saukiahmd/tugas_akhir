...
$result = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_kategoriwilayah='$_GET[id]'");
$total = mysqli_num_rows($result);
$pages = ceil($total/$halaman);            
$query = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_kategoriwilayah='$_GET[id]' LIMIT $mulai, $halaman")or die(mysqli_error);
